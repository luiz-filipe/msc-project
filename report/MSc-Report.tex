...
\ctparttext{In this first part a introduction to the project is given, also some background information and an overview of the proposed computational model are presented. More details of the computational model are left to be shown later on with the experiments descriptions.} % Text on the Part 1 page describing  the content in Part 1

\part{Setting The Context} % First part of the thesis

\include{Chapters/introduction}
\include{Chapters/background-information}
\include{Chapters/model-overview}
...
\include{Chapters/experiments-and-observations}
\include{Chapters/future-work} % Chapter 3
...
\include{Chapters/extra-experiments}
\include{Chapters/extra-code}
