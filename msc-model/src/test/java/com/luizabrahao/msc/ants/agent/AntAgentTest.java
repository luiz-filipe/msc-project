...
public class AntAgentTest {
	...
	public void incrementRadius3() {
		...
		assertTrue(grid[2][1].getCommunicationStimulus(attack).getIntensity() == a.getAgentType().getStimulusIncrement(attack.getName()) / 2);
		...
		assertTrue(grid[2][5].getCommunicationStimulus(attack).getIntensity() == a.getAgentType().getStimulusIncrement(attack.getName()) / 2);
		assertTrue(grid[2][6].getCommunicationStimulus(attack).getIntensity() == 0);
		
		assertTrue(grid[3][0].getCommunicationStimulus(attack).getIntensity() == a.getAgentType().getStimulusIncrement(attack.getName()) / 3);
		assertTrue(grid[3][1].getCommunicationStimulus(attack).getIntensity() == a.getAgentType().getStimulusIncrement(attack.getName()) / 2);
		...
		assertTrue(grid[3][5].getCommunicationStimulus(attack).getIntensity() == a.getAgentType().getStimulusIncrement(attack.getName()) / 2);
		assertTrue(grid[3][6].getCommunicationStimulus(attack).getIntensity() == a.getAgentType().getStimulusIncrement(attack.getName()) / 3);
		
		assertTrue(grid[4][0].getCommunicationStimulus(attack).getIntensity() == 0);
		assertTrue(grid[4][1].getCommunicationStimulus(attack).getIntensity() == a.getAgentType().getStimulusIncrement(attack.getName()) / 2);
		...
		assertTrue(grid[4][5].getCommunicationStimulus(attack).getIntensity() == a.getAgentType().getStimulusIncrement(attack.getName()) / 2);
