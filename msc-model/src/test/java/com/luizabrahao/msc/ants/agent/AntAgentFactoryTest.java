...
public class AntAgentFactoryTest {
	...
	public void executionTest() throws InterruptedException {
		...
		this.setIntensity(0, nLines, 0, nColumns, WorkerType.PHEROMONE_INCREMENT * 10, grid);
		
		final List<Future<Void>> futures = executor.invokeAll(agents, 20, TimeUnit.SECONDS);
		
		renderers.add(new PheromoneRenderer(grid, "target/forage-pheromone-end.png", nColumns, nLines));
