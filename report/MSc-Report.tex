...
\ctparttext{In this first part, an introduction to the field is given. Background information and an overview of the proposed computational model are also presented.} % Text on the Part 1 page describing  the content in Part 1
